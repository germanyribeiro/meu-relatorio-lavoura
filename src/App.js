    ...
    <div className="p-6 bg-white rounded-2xl shadow-lg">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div ref={reportContentRef} className={`
          p-4 sm:p-6
          ${isPdfMode ? 'px-8 py-8 text-base' : 'md:p-12 lg:px-28 lg:py-20'} 
          border border-gray-200 rounded-xl bg-gray-50 space-y-4
        `}>
          <h3 className={`text-xl font-bold text-green-700 mb-4 text-center ${isPdfMode ? 'text-lg' : ''}`}>Informações da Visita</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label htmlFor="propriedade" className={`block font-semibold text-gray-700 mb-1 ${isPdfMode ? 'text-base' : 'text-lg'}`}>Nome da Propriedade:</label>
              <input
                type="text"
                id="propriedade"
                name="propriedade"
                ...
                required
                className={`mt-1 block w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-green-500 focus:border-green-500 ${isPdfMode ? 'text-base' : 'text-lg'}`}
              />
            </div>
            <div>
              <label htmlFor="lavoura" className={`block font-semibold text-gray-700 mb-1 ${isPdfMode ? 'text-base' : 'text-lg'}`}>Nome da Lavoura:</label>
              <input
                type="text"
                id="lavoura"
                name="lavoura"
            ...
            <div>
              <label htmlFor="dataVisita" className={`block font-semibold text-gray-700 mb-1 ${isPdfMode ? 'text-base' : 'text-lg'}`}>Data da Visita:</label>
              <input
                type="date"
                id="dataVisita"
                name="dataVisita"
            ...
            <div>
              <label htmlFor="condicoesClimaticas" className={`block font-semibold text-gray-700 mb-1 ${isPdfMode ? 'text-base' : 'text-lg'}`}>Condições Climáticas:</label>
              <input
                type="text"
            ...
            <div>
              <label htmlFor="responsavelTecnico" className={`block font-semibold text-gray-700 mb-1 ${isPdfMode ? 'text-base' : 'text-lg'}`}>Responsável Técnico:</label>
              <input
                type="text"
          ...
          <div>
            <label htmlFor="estagioFenologico" className={`block font-semibold text-gray-700 mb-1 ${isPdfMode ? 'text-base' : 'text-lg'}`}>Estágio Fenológico Observado:</label>
            <input
              type="text"
          ...
          <div>
            <label htmlFor="observacoesGerais" className={`block font-semibold text-gray-700 mb-1 ${isPdfMode ? 'text-base' : 'text-lg'}`}>Observações Gerais da Lavoura:</label>
            <textarea
          ...
          <div>
            <label htmlFor="problemasIdentificados" className={`block font-semibold text-gray-700 mb-1 ${isPdfMode ? 'text-base' : 'text-lg'}`}>Problemas Identificados (Pragas, Doenças, Daninhas, etc.):</label>
            <textarea
          ...
          <div>
            <label htmlFor="orientacoesTecnicas" className={`block font-semibold text-gray-700 mb-1 ${isPdfMode ? 'text-base' : 'text-lg'}`}>Orientações Técnicas Fornecidas:</label>
            <textarea
          ...
          <div>
            <label htmlFor="potencialProdutivo" className={`block font-semibold text-gray-700 mb-1 ${isPdfMode ? 'text-base' : 'text-lg'}`}>Padrão de Qualidade e Potencial Produtivo Estimado:</label>
            <textarea
  ...
  return (
    <div className="p-6 bg-white rounded-2xl shadow-lg">
      ...
      <div ref={reportContentRef} className={`
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <p className={`font-semibold text-gray-700 mb-1 ${isPdfMode ? 'text-base' : 'text-lg'}`}>Nome da Propriedade:</p>
            <p className={`text-gray-900 font-semibold ${isPdfMode ? 'text-base' : 'text-xl'}`}>{report.propriedade}</p>
          </div>
          <div>
            <p className={`font-semibold text-gray-700 mb-1 ${isPdfMode ? 'text-base' : 'text-lg'}`}>Nome da Lavoura:</p>
            <p className={`text-gray-900 font-semibold ${isPdfMode ? 'text-base' : 'text-xl'}`}>{report.lavoura}</p>
          </div>
          <div>
            <p className={`font-semibold text-gray-700 mb-1 ${isPdfMode ? 'text-base' : 'text-lg'}`}>Data da Visita:</p>
            <p className={`text-gray-900 font-semibold ${isPdfMode ? 'text-base' : 'text-xl'}`}>{new Date(report.dataVisita).toLocaleDateString('pt-BR')}</p>
          </div>
          <div>
            <p className={`font-semibold text-gray-700 mb-1 ${isPdfMode ? 'text-base' : 'text-lg'}`}>Condições Climáticas:</p>
            <p className={`text-gray-900 font-semibold ${isPdfMode ? 'text-base' : 'text-xl'}`}>{report.condicoesClimaticas}</p>
          </div>
          <div>
            <p className={`font-semibold text-gray-700 mb-1 ${isPdfMode ? 'text-base' : 'text-lg'}`}>Responsável Técnico:</p>
            <p className={`text-gray-900 font-semibold ${isPdfMode ? 'text-base' : 'text-xl'}`}>{report.responsavelTecnico}</p>
          </div>
        </div>

        <h3 className={`text-xl font-bold text-green-700 mt-6 mb-4 text-center ${isPdfMode ? 'text-lg' : ''}`}>Observações Técnicas</h3>
        <div>
          <p className={`font-semibold text-gray-700 mb-1 ${isPdfMode ? 'text-base' : 'text-lg'}`}>Estágio Fenológico Observado:</p>
          <p className={`text-gray-900 ${isPdfMode ? 'text-base' : 'text-xl'}`}>{report.estagioFenologico}</p>
        </div>

        <div>
          <p className={`font-semibold text-gray-700 mb-1 ${isPdfMode ? 'text-base' : 'text-lg'}`}>Observações Gerais da Lavoura:</p>
          <p className={`text-gray-900 ${isPdfMode ? 'text-base' : 'text-xl'}`}>{report.observacoesGerais}</p>
        </div>

        <div>
          <p className={`font-semibold text-gray-700 mb-1 ${isPdfMode ? 'text-base' : 'text-lg'}`}>Problemas Identificados:</p>
          <p className={`text-gray-900 ${isPdfMode ? 'text-base' : 'text-xl'}`}>{report.problemasIdentificados}</p>
        </div>

        <div>
          <p className={`font-semibold text-gray-700 mb-1 ${isPdfMode ? 'text-base' : 'text-lg'}`}>Orientações Técnicas Fornecidas:</p>
          <p className={`text-gray-900 ${isPdfMode ? 'text-base' : 'text-xl'}`}>{report.orientacoesTecnicas}</p>
        </div>

        <div>
          <p className={`font-semibold text-gray-700 mb-1 ${isPdfMode ? 'text-base' : 'text-lg'}`}>Padrão de Qualidade e Potencial Produtivo Estimado:</p>
          <p className={`text-gray-900 ${isPdfMode ? 'text-base' : 'text-xl'}`}>{report.potencialProdutivo}</p>
        </div>
